...
function renderLogin(){
  ...
  app.innerHTML = `
    ...
    <div class="card">
      ...
      <label class="remember-row" style="display:flex; align-items:center; gap:8px; margin-top:10px; cursor:pointer;">
  ...
  $("#login-btn").onclick = ()=>{
    ...
    if(member && member.password===p){
      ...
      persistSession(state.session, $("#login-remember").checked);
      state.view = "home";
      render();
...
function renderPhoneLogin(){
  app.innerHTML = `
    ...
    <div class="card">
      ...
      <div id="otp-verify-block" style="display:none; margin-top:16px;">
        ...
        <label class="remember-row" style="display:flex; align-items:center; gap:8px; margin:10px 0;cursor:pointer;">
  ...
  $("#otp-verify").onclick = ()=>{
    ...
    persistSession(state.session, $("#otp-remember").checked);
